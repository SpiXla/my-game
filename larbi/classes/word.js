...
export class Word {
        ...
        if (e.key == "Escape") {
            ...
            if (restartBtn) {
                restartBtn.addEventListener("click", () => {
                    this.ispaused = false;
                    removeEventListener("keydown",this.hh)
                });
            }
    ...
    pauseGame() {
        document.addEventListener("keydown",this.hh)
    }
    ...
    move() {
        const moveEnemy = () => {
            ...
            // Ensure the ship element exists
            ...
            const shipRectAdjusted = ship.getBoundingClientRect();
